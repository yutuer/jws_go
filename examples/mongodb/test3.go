...
func main() {
	...
	c := session.DB("test").C("people1")

	index := mgo.Index{
		Key:         []string{"timestamp"},
		ExpireAfter: time.Second * 60,
	}
	...
	err = c.Insert(&Person{
		Name: "Ale", Phone: "+55 53 8116 9639", Other: "1", Timestamp: time.Now()},
		&Person{Name: "Cla", Phone: "+55 53 8402 8510", Other: "2", Timestamp: time.Now()})
	if err != nil {
		log.Fatal(err)
	}
