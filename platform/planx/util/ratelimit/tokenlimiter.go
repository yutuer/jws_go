...
func (tl *TokenLimiter) Consume(req *http.Request) error {
...
func Logger(l *limiterLogger) TokenLimiterOption {
...
func (l *limiterLogger) Infof(format string, args ...interface{}) {
	logs.Info(format, args...)
}

func (l *limiterLogger) Warningf(format string, args ...interface{}) {
	logs.Warn(format, args...)
}

func (l *limiterLogger) Errorf(format string, args ...interface{}) {
