...
public sealed class AccountInfo : Table {
  ...
  ///玩家当前灵宠形象
  public uint MagicPetfigure { get { int o = __offset(88); return o != 0 ? bb.GetUint(o + bb_pos) : (uint)0; } }
  ...
  public static void StartAccountInfo(FlatBufferBuilder builder) { builder.StartObject(43); }
  ...
  public static void AddMagicPetfigure(FlatBufferBuilder builder, uint magicPetfigure) { builder.AddUint(42, magicPetfigure, 0); }
