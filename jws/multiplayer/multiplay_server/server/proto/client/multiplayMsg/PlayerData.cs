...
public sealed class PlayerData : Table {
  ...
  public multiplayMsg.PlayerSimpleData SimpleData { get { return GetSimpleData(new multiplayMsg.PlayerSimpleData()); } }
  public multiplayMsg.PlayerSimpleData GetSimpleData(multiplayMsg.PlayerSimpleData obj) { int o = __offset(4); return o != 0 ? obj.__init(__indirect(o + bb_pos), bb) : null; }
  ...
  public multiplayMsg.Vector StartAttackPos { get { return GetStartAttackPos(new multiplayMsg.Vector()); } }
  public multiplayMsg.Vector GetStartAttackPos(multiplayMsg.Vector obj) { int o = __offset(10); return o != 0 ? obj.__init(__indirect(o + bb_pos), bb) : null; }
  public multiplayMsg.Vector StartAttackDir { get { return GetStartAttackDir(new multiplayMsg.Vector()); } }
  public multiplayMsg.Vector GetStartAttackDir(multiplayMsg.Vector obj) { int o = __offset(12); return o != 0 ? obj.__init(__indirect(o + bb_pos), bb) : null; }
  ...
  public static Offset<PlayerData> CreatePlayerData(FlatBufferBuilder builder,
      Offset<multiplayMsg.PlayerSimpleData> simpleDataOffset = default(Offset<multiplayMsg.PlayerSimpleData>),
      int releaseSkillID = 0,
      int comboCount = 0,
      Offset<multiplayMsg.Vector> startAttackPosOffset = default(Offset<multiplayMsg.Vector>),
      Offset<multiplayMsg.Vector> startAttackDirOffset = default(Offset<multiplayMsg.Vector>),
  ...
  public static void AddSimpleData(FlatBufferBuilder builder, Offset<multiplayMsg.PlayerSimpleData> simpleDataOffset) { builder.AddOffset(0, simpleDataOffset.Value, 0); }
  ...
  public static void AddStartAttackPos(FlatBufferBuilder builder, Offset<multiplayMsg.Vector> startAttackPosOffset) { builder.AddOffset(3, startAttackPosOffset.Value, 0); }
  public static void AddStartAttackDir(FlatBufferBuilder builder, Offset<multiplayMsg.Vector> startAttackDirOffset) { builder.AddOffset(4, startAttackDirOffset.Value, 0); }
