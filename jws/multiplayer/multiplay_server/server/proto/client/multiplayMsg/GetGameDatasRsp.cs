...
public sealed class GetGameDatasRsp : Table {
  ...
  public multiplayMsg.PlayerState GetPlayerStat(multiplayMsg.PlayerState obj, int j) { int o = __offset(14); return o != 0 ? obj.__init(__indirect(__vector(o) + j * 4), bb) : null; }
  ...
  public multiplayMsg.BossState GetBossStat(multiplayMsg.BossState obj, int j) { int o = __offset(16); return o != 0 ? obj.__init(__indirect(__vector(o) + j * 4), bb) : null; }
  ...
  public multiplayMsg.AccountInfo GetAccDatas(multiplayMsg.AccountInfo obj, int j) { int o = __offset(18); return o != 0 ? obj.__init(__indirect(__vector(o) + j * 4), bb) : null; }
  ...
  public multiplayMsg.AcDataInfo GetAcDatas(multiplayMsg.AcDataInfo obj, int j) { int o = __offset(20); return o != 0 ? obj.__init(__indirect(__vector(o) + j * 4), bb) : null; }
