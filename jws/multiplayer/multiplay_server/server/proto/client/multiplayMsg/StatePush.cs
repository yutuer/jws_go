...
public sealed class StatePush : Table {
  ...
  ///boss护甲
  public long GetBossArmor(int j) { int o = __offset(18); return o != 0 ? bb.GetLong(__vector(o) + j * 8) : (long)0; }
  public int BossArmorLength { get { int o = __offset(18); return o != 0 ? __vector_len(o) : 0; } }
  public ArraySegment<byte>? GetBossArmorBytes() { return __vector_as_arraysegment(18); }
  ///玩家上次伤害类型
  public int LastDamageTyp { get { int o = __offset(20); return o != 0 ? bb.GetInt(o + bb_pos) : (int)0; } }
  ...
  public static Offset<StatePush> CreateStatePush(FlatBufferBuilder builder,
    ...
    StatePush.AddBossArmor(builder, bossArmorOffset);
  ...
  public static void StartStatePush(FlatBufferBuilder builder) { builder.StartObject(9); }
  ...
  public static void AddBossArmor(FlatBufferBuilder builder, VectorOffset bossArmorOffset) { builder.AddOffset(7, bossArmorOffset.Value, 0); }
  ...
  public static void AddLastDamageTyp(FlatBufferBuilder builder, int lastDamageTyp) { builder.AddInt(8, lastDamageTyp, 0); }
