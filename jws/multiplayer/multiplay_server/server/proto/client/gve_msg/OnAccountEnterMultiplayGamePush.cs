...
public sealed class OnAccountEnterMultiplayGamePush : Table {
  ...
  public gve_msg.PlayerState GetPlayerStat(gve_msg.PlayerState obj, int j) { int o = __offset(4); return o != 0 ? obj.__init(__indirect(__vector(o) + j * 4), bb) : null; }
  ...
  public gve_msg.AccountInfo GetAccDatas(gve_msg.AccountInfo obj, int j) { int o = __offset(6); return o != 0 ? obj.__init(__indirect(__vector(o) + j * 4), bb) : null; }
