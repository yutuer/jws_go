...
public sealed class BossSimpleData : Table {
  ...
  public teamboss_msg.Vector BossPosition { get { return GetBossPosition(new teamboss_msg.Vector()); } }
  public teamboss_msg.Vector GetBossPosition(teamboss_msg.Vector obj) { int o = __offset(10); return o != 0 ? obj.__init(__indirect(o + bb_pos), bb) : null; }
  public teamboss_msg.Vector BossDirection { get { return GetBossDirection(new teamboss_msg.Vector()); } }
  public teamboss_msg.Vector GetBossDirection(teamboss_msg.Vector obj) { int o = __offset(12); return o != 0 ? obj.__init(__indirect(o + bb_pos), bb) : null; }
  ...
  public static Offset<BossSimpleData> CreateBossSimpleData(FlatBufferBuilder builder,
      ...
      int bossState = 0,
      Offset<teamboss_msg.Vector> bossPositionOffset = default(Offset<teamboss_msg.Vector>),
      Offset<teamboss_msg.Vector> bossDirectionOffset = default(Offset<teamboss_msg.Vector>),
  ...
  public static void AddBossPosition(FlatBufferBuilder builder, Offset<teamboss_msg.Vector> bossPositionOffset) { builder.AddOffset(3, bossPositionOffset.Value, 0); }
  public static void AddBossDirection(FlatBufferBuilder builder, Offset<teamboss_msg.Vector> bossDirectionOffset) { builder.AddOffset(4, bossDirectionOffset.Value, 0); }
