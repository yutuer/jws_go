...
public sealed class GetGameDatasRsp : Table {
  ...
  public teamboss_msg.AccountInfo GetAccDatas(teamboss_msg.AccountInfo obj, int j) { int o = __offset(18); return o != 0 ? obj.__init(__indirect(__vector(o) + j * 4), bb) : null; }
  ...
  public teamboss_msg.AcDataInfo GetAcDatas(teamboss_msg.AcDataInfo obj, int j) { int o = __offset(20); return o != 0 ? obj.__init(__indirect(__vector(o) + j * 4), bb) : null; }
