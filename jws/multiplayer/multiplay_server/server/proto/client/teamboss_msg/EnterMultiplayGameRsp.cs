...
public sealed class EnterMultiplayGameRsp : Table {
  ...
  public teamboss_msg.AccountInfo GetAccDatas(teamboss_msg.AccountInfo obj, int j) { int o = __offset(14); return o != 0 ? obj.__init(__indirect(__vector(o) + j * 4), bb) : null; }
  public int AccDatasLength { get { int o = __offset(14); return o != 0 ? __vector_len(o) : 0; } }
  ///当前房间中Boss的数据
  public teamboss_msg.AcDataInfo GetAcDatas(int j) { return GetAcDatas(new teamboss_msg.AcDataInfo(), j); }
  public teamboss_msg.AcDataInfo GetAcDatas(teamboss_msg.AcDataInfo obj, int j) { int o = __offset(16); return o != 0 ? obj.__init(__indirect(__vector(o) + j * 4), bb) : null; }
  ...
  public teamboss_msg.PlayerState GetPlayerStat(teamboss_msg.PlayerState obj, int j) { int o = __offset(18); return o != 0 ? obj.__init(__indirect(__vector(o) + j * 4), bb) : null; }
  ...
  public teamboss_msg.BossState GetBossStat(teamboss_msg.BossState obj, int j) { int o = __offset(20); return o != 0 ? obj.__init(__indirect(__vector(o) + j * 4), bb) : null; }
  ...
  public static void StartEnterMultiplayGameRsp(FlatBufferBuilder builder) { builder.StartObject(11); }
  ...
  public static VectorOffset CreateAcDatasVector(FlatBufferBuilder builder, Offset<teamboss_msg.AcDataInfo>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
