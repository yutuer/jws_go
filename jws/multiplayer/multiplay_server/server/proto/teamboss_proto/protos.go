...
func GenEnterMultiplayGameRsp(req msgprocessor.IPacket, stat *TBGameState, datas *TBGameDatas) []byte {
	builder := GetNewBuilder()
...
func GenGetGameDataRsp(req msgprocessor.IPacket, stat *TBGameState, datas *TBGameDatas) []byte {
	builder := GetNewBuilder()
	return GenPacketRsp(builder,
		req.Typ(),
		req.Number(),
...
func GenGetGameStatRsp(req msgprocessor.IPacket, stat *TBGameState, datas *TBGameDatas) []byte {
	builder := GetNewBuilder()
	return GenPacketRsp(builder,
		req.Typ(),
		req.Number(),
...
func GenStatePush(stat *TBGameState, lead string) []byte {
	builder := GetNewBuilder()
	return GenPacketRsp(builder,
...
func GenGetGameRwardRsp(req msgprocessor.IPacket, idx int, datas *TBGameDatas) []byte {
	return nil
}

func GenEnemyWaveHP(state *TBGameState, wave int32) []byte {
	builder := GetNewBuilder()
	return GenPacketRsp(builder,
		msgprocessor.MsgTypPush,
		0,
...
func MkEnterMultiplayGameRsp(builder *flatbuffers.Builder, stat *TBGameState, datas *TBGameDatas) flatbuffers.UOffsetT {
...
func MkGetGameStatRsp(builder *flatbuffers.Builder, stat *TBGameState) flatbuffers.UOffsetT {
	h := NewFlatBufferHelper(builder, 32)
...
func MkGetGameDataRsp(builder *flatbuffers.Builder, stat *TBGameState, datas *TBGameDatas) flatbuffers.UOffsetT {
	h := NewFlatBufferHelper(builder, 32)
...
func MkStatePush(builder *flatbuffers.Builder, stat *TBGameState, lead string) flatbuffers.UOffsetT {
	h := NewFlatBufferHelper(builder, 32)
...
func MkEnemyWaveHP(builder *flatbuffers.Builder, stat *TBGameState, wave int32) flatbuffers.UOffsetT {
